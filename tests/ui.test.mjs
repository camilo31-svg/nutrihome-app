...
for (const asset of ['nutrihome-core.js', 'demo-data.js', 'recipe-library.js', 'recipe-estimator.js', 'storage.js', 'app.js', 'recipe-plate-atlas-v2.jpg']) assert.equal(worker.includes(asset), true);
...
await access(new URL('../recipe-plate-atlas-v2.jpg', import.meta.url));
assert.match(app, /ingredient-cloud/);
