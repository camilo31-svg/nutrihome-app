...
for (const filename of ['index.html', 'styles.css', 'nutrihome-core.js', 'demo-data.js', 'recipe-library.js', 'recipe-estimator.js', 'storage.js', 'app.js', 'sw.js', 'manifest.webmanifest', 'og.png', 'recipe-plate-atlas-v2.jpg']) {
